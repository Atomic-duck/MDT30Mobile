         ...
         <TouchableOpacity style={styles.modalContainer} activeOpacity={1} >
            <View style={styles.modalContent}>
               <View style={styles.header}>
                  <Text style={styles.modalText}>Giao thông</Text>
               ...
               <View style={styles.itemContainer}>
                  <View style={styles.item}>
                     <Pressable style={[styles.avatar, value == 'Hơi ùn tắc' && styles.picked]} onPress={() => toggle('Hơi ùn tắc')}>
                        <Image source={JamTraffic} height={16} width={16} />
                     </Pressable>
                     <Text style={styles.title}>Hơi ùn tắc</Text>
                  </View>
                  <View style={styles.item}>
                     <Pressable style={[styles.avatar, styles.heavy, value == 'Ùn tắc' && styles.picked]} onPress={() => toggle('Ùn tắc')}>
                        <Image source={JamTraffic} height={16} width={16} />
                     </Pressable>
                     <Text style={styles.title}>Ùn tắc</Text>
                  </View>
                  <View style={styles.item}>
                     <Pressable style={[styles.avatar, styles.standtill, value == 'Tắc nghẽn' && styles.picked]} onPress={() => toggle('Tắc nghẽn')}>
                        <Image source={JamTraffic} height={16} width={16} />
                     </Pressable>
                     <Text style={styles.title}>Tắc nghẽn</Text>
                  </View>
               </View>
